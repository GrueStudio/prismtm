...
class TestSchemaDiff:
    ...
    def test_detect_added_fields(self):
        ...
        diff = SchemaDiff.compare_schemas(old_schema, new_schema)
...
class TestMigrationGenerator:
    ...
    def test_generate_migration(self, mock_exists, mock_json_load, mock_file):
        ...
        with patch.object(generator, '_write_migration_file') as mock_write:
            generator.generate_migration("0.0.0", "0.1.0")
